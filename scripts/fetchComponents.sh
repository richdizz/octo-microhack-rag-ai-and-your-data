...
cp -r ./code/gpt-rag-ingestion ./.azure/gpt-rag-ingestion
...
cp -r ./code/gpt-rag-orchestrator ./.azure/gpt-rag-orchestrator
...
cp -r ./code/gpt-rag-frontend ./.azure/gpt-rag-frontend
